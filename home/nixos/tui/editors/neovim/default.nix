...
let
  ...
  # WARN: to make this symlink work, we need to git clone this repo to your home directory.
  configPath = "${config.home.homeDirectory}/nix-config/home/nixos/tui/editors/neovim/nvim";
in
{
  ...
  programs.neovim = {
    ...
    plugins = with pkgs.vimPlugins; [
      ...
      # we need the `tree-sitter-cli` to use the `auto_install` feature.
      # [AstroNvim Requirements](https://docs.astronvim.com/)
