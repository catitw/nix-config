...
-- NOTE: `selene` support `aarch64` actually, but it doesn't have pre-built releases,
-- and lead to mason do NOT support it.
-- But, we have installed it with `NixOS` config.
--
--
--
--
-- see:
-- - [astrocommunity#1464](https://github.com/AstroNvim/astrocommunity/pull/1464)
-- - [selene#638](https://github.com/Kampfkarren/selene/pull/638)
--
